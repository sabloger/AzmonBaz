...
//        public TextView courseTitle_tv;
        public AppCompatImageView course_imgv;
...
//            courseTitle_tv = (TextView) itemView.findViewById(R.id.courseTitle_tv);
            ...
            course_imgv = (AppCompatImageView) itemView.findViewById(R.id.course_imgv);
        }
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_courses_test, parent, false);
...
//        if (!courses.get(position).getBackColor().equals("")) {
...
//        holder.courseIcon_imgv.setImageResource(resIcon);
        new ImageLoad("Backgrounds/" + courses.get(position).getBackImage(), holder.course_imgv);
    }
